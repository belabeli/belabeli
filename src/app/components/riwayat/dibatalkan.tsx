  ...
  <>
    ...
    <div className="relative items-center py-3 text-sm transition-all duration-200 rounded-md cursor-pointer text-black-80 border-white-30 w-full max-w-[444px] bg-gray-100 mt-3">
        ...
        <div className="flex items-center justify-between h-[38px]">
            ...
            <div className="pr-4">
                <button className="h-6 w-24 rounded-md border-2 border-[#EE443F] bg-[#FCDAD9] text-[#EE443F] text-[10px] font-bold">Dibatalkan</button>
            </div>
        </div>
        </Link>

        {/* --- Body toko ----- */}
        <div className="mt-2 p-3 border-t-2 justify-start gap-3 flex">
            <Link href={'/transaksi/detail/89912891?q=dibatalkan'} className="flex gap-x-3">
            <div className="w-2/6"> 
        ...
        <div className="w-full px-3">
            <button className="w-full rounded-md bg-[#51D7B1] p-2 text-white font-medium text-sm text-center"> Beli Lagi 
            </button>
        </div>
        </Link>
    </div>
