        ...
        <div className="mt-2 p-3 border-t-2 flex justify-start gap-3">
            ...
            <div className="w-4/6"> 
                ...
                <div className="w-full justify-center mt-4">
                    <Link href={`/beri-ulasan`} className="w-full">
                        <button className="bg-[#FDFDFD] text-[#51D7B1] border-[#51D7B1] border-2 font-semibold py-2 px-2 rounded-l-lg w-1/2 text-[12px]">
                            Kirim Ulasan
                        </button>
                    </Link>
                    <Link href={`/product/sepatu-anak`} className="w-full">
                        <button className="bg-[#51D7B1] border-2 border-[#51D7B1] text-white font-semibold py-2 px-2 rounded-r-lg w-1/2 text-[12px] border-l-4 ">
                            Beli Lagi
                        </button>
                    </Link>
                </div>
    ...
    <div className="relative items-center py-3 text-sm transition-all duration-200 rounded-md cursor-pointer text-black-80 border-white-30 w-full max-w-[444px] bg-gray-100 mt-3">
        ...
        <div className="mt-2 p-3 border-t-2 flex justify-start gap-3">
            ...
            <div className="w-4/6"> 
                ...
                <div className="w-full justify-center mt-4">
                    <Link href={`/beri-ulasan/detail-ulasan`} className="w-full">
                        <button className="bg-[#E2F8F2] text-[#51D7B1] border-[#51D7B1] border-2 font-semibold py-2 px-2 rounded-l-lg w-1/2 text-[12px]">
                            Lihat Ulasan
                        </button>
                    </Link>
                    <Link href={`/product/sepatu-anak`} className="w-full">
    ...
    {isModalOpen && (
        ...
        <div id="modal" className="font-nunito fixed inset-y-1/2 flex justify-center items-center z-[100] w-[360px] left-1/2 -translate-x-1/2 shadow-lg">
            ...
            className={`bg-white w-full max-w-lg rounded-3xl p-6 absolute inset-y-auto -translate-y-1/2`}>
                ...
                <div className="mt-6">
                    <button onClick={closeModal} className="w-full bg-[#51D7B1] text-white font-bold py-3 rounded-lg hover:bg-[#51D7B1]">
                        Tutup
                    </button>
                </div>
            </div>
