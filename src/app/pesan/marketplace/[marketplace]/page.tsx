...
import PengembalianStatus from "@/app/components/pesan/pengembalian-status";
import PengembalianProduct from "@/app/components/pesan/pengembalian-product";
import KonfirmasiNegosiasi from "@/app/components/pesan/konfirmasi-negosiasi";

const Marketplace = () => {

    return (
    <>
    <Header title="Toko Anugrah Shoes" children={undefined}/>
        <div className="px-4 font-nunito absolute py-20 items-center w-[400px] left-1/2 -translate-x-1/2">
            ...
            <div className="mt-2">
                <PengembalianProduct></PengembalianProduct>
                <KonfirmasiNegosiasi></KonfirmasiNegosiasi>
                ...
                <div className="flex justify-end mb-2">
                    <div className="flex flex-wrap justify-start items-center max-w-xs bg-green-100 py-2 px-4 rounded-lg shadow-lg">
                        <p className="text-sm text-gray-800"> Apakah transaksi retur saya bisa diproses?</p>
                        <span className="flex flex-wrap items-center justify-end text-xs text-gray-400 text-right w-full gap-1">
                            <p>9:30</p> 
                            <Checklist></Checklist>
                        </span>
                ...
                <div className="flex justify-start mb-2">
                    <div className="flex flex-wrap justify-start items-center max-w-xs bg-gray-100 py-2 px-4 rounded-lg shadow-lg">
                        <p className="text-sm text-gray-800">Halo, Baik!</p>
                        <span className="flex flex-wrap items-center justify-end text-xs text-gray-400 text-right w-full gap-1">
                            <p>9:30</p> 
                            <Checklist></Checklist>
                        </span>
                ...
                <div className="flex justify-start mb-2">
                    <div className="flex flex-wrap justify-start items-center max-w-xs bg-gray-100 py-2 px-4 rounded-lg shadow-lg">
                        <p className="text-sm text-gray-800"> Mohon tunggu ya </p>
                        <span className="flex flex-wrap items-center justify-end text-xs text-gray-400 text-right w-full gap-1">
                            <p>9:30</p> 
                            <Checklist></Checklist>
                        </span>
