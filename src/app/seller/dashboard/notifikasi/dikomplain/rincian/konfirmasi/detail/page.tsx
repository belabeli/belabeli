      ...
      <div className="flex flex-col min-h-screen font-nunito">
        ...
        <div className="container mx-auto p-4 flex-grow">
          ...
          <div className="mt-4 text-center">
            <h1 className="font-bold text-[24px] text-black">Pengajuan Dikonfirmasi</h1>
            <p className="text-sm text-black mt-4">
            Tidak Terdapat kendala pada proses pengembalian. Silakan Lanjutkan Proses refund            </p>
          </div>
