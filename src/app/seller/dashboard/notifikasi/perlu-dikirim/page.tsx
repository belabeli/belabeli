...
const notifications = [
  {
    id: 1,
    title: 'Pesanan ID 2344789010 Perlu dikirim ke pelanggan',
    time: '15:15',
    date: 'Baru saja',
    description:
  ...
  {
    id: 2,
    title: 'Pesanan ID 2344000010 Perlu dikirim ke pelanggan',
    time: '15:15',
...
function PerluDikirim() {
  ...
  const handleClick = () => {
    ...
    router.push('/seller/dashboard/notifikasi/perlu-dikirim/detail')
  }

  return (
    <LayoutUtama>
      <Header title="Perlu Dikirim" children={undefined} />
