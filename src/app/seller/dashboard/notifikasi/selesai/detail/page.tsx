      ...
      <div className="flex flex-col min-h-screen font-nunito">
        ...
        <div className="container mx-auto p-4 flex-grow">
          ...
          <div className="mt-4 text-center">
            <h1 className="font-bold text-[24px] text-black">Pesanan Diterima</h1>
            <p className="text-sm text-black mt-4">
            Selamat! pesanan dengan ID {orderDetail.id} telah sampai ke pembeli. Mohon cek detail transaksi 
            </p>
          </div>
