...
export default function OtpInput() {
  ...
  const handleButtonClick = () => {
    ...
    setTimeout(() => {
      setShowPopup(false);
      router.push("/seller/informasi-toko"); // Redirect setelah popup tertutup
    }, 3000);
  };
        ...
        <div className="container w-full max-w-[400px] mx-auto p-4 font-nunito mt-20 flex flex-col justify-center items-center">
          <div className="flex flex-col gap-2 items-center">
            ...
            <span className="w-full text-center text-md mt-2 px-8 text-gray-500">
              <p className="font-nunito ">Untuk keamanan akun, mohon verifikasi identitas anda dengan kode OTP yang telah dikirimkan ke Nomor Telepon</p>
            </span>
          </div>
