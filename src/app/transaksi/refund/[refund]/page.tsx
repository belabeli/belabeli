...
const Refund = () => {
    ...
    return (
      <>
        <Header title="Refund Barang" children={undefined} />
        ...
        <div className="px-4 font-nunito absolute py-20 mb-20 items-center w-[400px] left-1/2 -translate-x-1/2">
            ...
            {q === "proses" ? (
                ...
                <IconPendingGradation></IconPendingGradation>
                </div>

                <div className="justify-center flex-col items-center text-center mb-6">
                    <h2 className="!font-nunito font-semibold text-xl">Proses Refund Kamu Hampir Selesai</h2>
                    <p className="!font-nunito font-light text-xs pt-3 leading-tight">Barang mu telah diterima oleh penjual, harap menunggu penjual melakukan transfer dana</p>
                </div>    
                </>
            ) : ('')}
            ...
            {q === "selesai" ? (
                ...
                <div className="justify-center flex-col items-center text-center mb-6">
                    ...
                    <p className="!font-nunito font-light text-xs pt-3 leading-tight">Pengembalian dengan refund telah berhasil</p>
                </div>
                ...
                <div className="flex items-center space-x-2 px-2 pt-4">
                    <p className="font-semibold text-md text-black">Dana Dikembalikan Ke-</p>
                </div>
                ...
                <Link href={`/transaksi/refund/${refund}/bukti-transfer`}>
